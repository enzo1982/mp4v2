...
const EnumLanguageCode::Entry EnumLanguageCode::data[] = {
    ...
    { mp4v2::impl::bmff::ILC_ALB,  "alb",  "Albanian" },
    ...
    { mp4v2::impl::bmff::ILC_ARM,  "arm",  "Armenian" },
    ...
    { mp4v2::impl::bmff::ILC_BAQ,  "baq",  "Basque" },
    ...
    { mp4v2::impl::bmff::ILC_BUR,  "bur",  "Burmese" },
    ...
    { mp4v2::impl::bmff::ILC_CHI,  "chi",  "Chinese" },
    ...
    { mp4v2::impl::bmff::ILC_CZE,  "cze",  "Czech" },
    ...
    { mp4v2::impl::bmff::ILC_DUT,  "dut",  "Dutch; Flemish" },
    ...
    { mp4v2::impl::bmff::ILC_FRE,  "fre",  "French" },
    ...
    { mp4v2::impl::bmff::ILC_GEO,  "geo",  "Georgian" },
    { mp4v2::impl::bmff::ILC_GER,  "ger",  "German" },
    ...
    { mp4v2::impl::bmff::ILC_GRE,  "gre",  "Greek, Modern (1453-)" },
    ...
    { mp4v2::impl::bmff::ILC_ICE,  "ice",  "Icelandic" },
    ...
    { mp4v2::impl::bmff::ILC_MAC,  "mac",  "Macedonian" },
    ...
    { mp4v2::impl::bmff::ILC_PER,  "per",  "Persian" },
    ...
    { mp4v2::impl::bmff::ILC_RUM,  "rum",  "Romanian; Moldavian; Moldovan" },
    ...
    { mp4v2::impl::bmff::ILC_SLO,  "slo",  "Slovak" },
    ...
    { mp4v2::impl::bmff::ILC_TIB,  "tib",  "Tibetan" },
    ...
    { mp4v2::impl::bmff::ILC_WEL,  "wel",  "Welsh" },
